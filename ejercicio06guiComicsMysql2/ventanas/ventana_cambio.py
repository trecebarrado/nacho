...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(201, 110)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.lbl_cambio = QtWidgets.QLabel(self.centralwidget)
        self.lbl_cambio.setGeometry(QtCore.QRect(20, 10, 131, 20))
        font = QtGui.QFont()
        ...
        self.txt_cambio.setGeometry(QtCore.QRect(20, 40, 161, 20))
        font = QtGui.QFont()
        font.setFamily("Verdana")
        font.setPointSize(10)
        ...
        self.btn_cambio.setGeometry(QtCore.QRect(20, 70, 161, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_cambio.setText(_translate("MainWindow", "Cambiar"))
